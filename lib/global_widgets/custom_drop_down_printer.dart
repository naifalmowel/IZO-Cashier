...
class CustomDropDownButtonPrinter extends StatefulWidget {
  ...
  final String title;
  final String hint;
  final List<PrinterEntityData> items;
  int? value;
  ...
  @override
  State<CustomDropDownButtonPrinter> createState() => _CustomDropDownButtonPrinterState();
}

class _CustomDropDownButtonPrinterState extends State<CustomDropDownButtonPrinter> {
  int? val;
  var init = true;
        ...
        child: DropdownButton2<int>(
          ...
          dropdownSearchData: DropdownSearchData(
            ...
            searchMatchFn: (item, searchValue) {
              ...
              return ((myItem.printerName.toString()
                  .toLowerCase()
                  .toString()
                  .contains(
